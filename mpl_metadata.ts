...
async function main(){
    ...
    const myKeypair = loadWalletKey("/Users/arefgholami/Desktop/NOAAA/codeWith0xin/spl-token/payer2.json");
    const mint = new web3.PublicKey("22vTT3BU8t8v3t1JEBZc7qSDuCaEfgmMi2u9dBZJ6TrA");
