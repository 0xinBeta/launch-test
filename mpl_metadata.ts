...
async function main(){
    ...
    const myKeypair = loadWalletKey("/Users/arefgholami/Desktop/NOAAA/codeWith0xin/spl-token/payer1.json");
    const mint = new web3.PublicKey("4VL9DVHG6PapZUv3yE4YX42NzcwhqBK8vmDENhkXjS79");
