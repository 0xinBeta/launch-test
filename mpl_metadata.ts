...
async function main(){
    ...
    const myKeypair = loadWalletKey("/Users/arefgholami/Desktop/NOAAA/codeWith0xin/project-phoenix/fish/wallet_0.json");
    const mint = new web3.PublicKey("BVhv2Jii9XefoXso1Y32UhXEp6QojiFHfB2LGosNcpVn");
